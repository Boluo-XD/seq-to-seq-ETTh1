...
if __name__ == "__main__":
    ...
    # parser.add_argument("dataset", choices=["train_set", "test_set", "validation_set"])
    ...
    train_dataset = MyDataset(f"data/train_set.csv",
                              in_size=args.in_size, out_size=args.out_size,
                              seed=args.seed)
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True)
    val_dataset = MyDataset(f"data/validation_set.csv",
                            in_size=args.in_size, out_size=args.out_size,
                            seed=args.seed)
    ...
    min_mae = float("inf")
    log_dir = "./logs/{}/{}".format('ETTh1', args.model)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if mae < min_mae:
            ...
            torch.save(checkpoint, os.path.join(log_dir, "checkpoint_best_new.pth"))
