...
if __name__ == "__main__":
    ...
    test_dataset = MyDataset(f"data/test_set.csv",
    ...
    checkpoint = torch.load(os.path.join(log_dir, "checkpoint_best_336_3000.pth"), map_location="cpu")
    ...
    plt.legend()
    plt.savefig("prediction_new_gengxin.png")
